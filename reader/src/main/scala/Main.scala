...
object Main extends IOApp:
  ...
  override def run(args: List[String]): IO[ExitCode] =
    ...
    (for
      ...
      schemasConsumer   <- SchemasKafkaConsumerImpl.make[IO](NonEmptyList.one(kafka.schemasTopic), schemaConsumerSettings, contractsProducer)
